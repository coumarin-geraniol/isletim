...
//
$ldap_server[$serverId]['binddn']	= "cn=admin,dc=consttier,dc=tech";
$ldap_server[$serverId]['bindpw']	= "root";
...
$ldap_queries[$query_id]['ldapServerId'] = 0;
$ldap_queries[$query_id]['name'] = 'All Users';
$ldap_queries[$query_id]['userbase'] = 'ou=users,dc=consttier,dc=tech';
...
$query_id++;
$ldap_queries[$query_id]['ldapServerId'] = 0;
$ldap_queries[$query_id]['name'] = 'User Group';
$ldap_queries[$query_id]['groupbase'] = 'ou=groups,dc=consttier,dc=tech';
$ldap_queries[$query_id]['groupfilter'] = '(&(cn=user)(objectClass=posixGroup))';
$ldap_queries[$query_id]['groupscope'] = 'sub';
$ldap_queries[$query_id]['groupmemberattr'] = 'memberUid';
$ldap_queries[$query_id]['groupmemberisdn'] = false;
$ldap_queries[$query_id]['useridattr'] = 'uid';
